...
function(mengshee_find_toolchain)
...
function(mengshee_prepare_build_dir build_dir allowed_root source_dir)
    ...
    if(_remove_build_dir)
        mengshee_remove_inside("${build_dir}" "${allowed_root}")
    endif()
...
function(mengshee_run_vs command_line)
    ...
    set(_cmd_file "${WORKSPACE_ROOT}/tmp/mengshee-kf6-vs-env.cmd")
...
function(mengshee_ensure_git_checkout url ref destination)
