...
void Annotation::setPreviousAnnotation(Annotation *annotation)
{
    Q_D(Annotation);
    d->m_previousRevision = annotation;
}

Okular::Annotation *Annotation::previousAnnotation()
{
    Q_D(Annotation);
    return d->m_previousRevision;
}
